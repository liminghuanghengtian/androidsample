package com.example.modulehotfix;
 ...
 * PackageName: com.example.modulehotfix
 * Description:
 * <p>
 * CreateTime: 2017/12/16 21:38
 * Modifier: Adaministrator
 * ModifyTime: 2017/12/16 21:38
 * Comment：
 *
...
public class HotFixEngine {
     ...
     * @return
     */
    public Object getDexPathListField(Object classLoader) throws ClassNotFoundException, NoSuchFieldException,
     ...
     * @return
     */
    public Object getField(Object obj, Class<?> clz, String fieldName) throws NoSuchFieldException,
            IllegalAccessException {
     ...
     * @param value
     */
    public void setFiledValue(Object obj, Class<?> claz, String filed, Object value) throws NoSuchFieldException,
            IllegalAccessException {
    ...
    public void mergeDex(Context context, File fixDexPath, File dexFile) {
        try {
            ...
            DexClassLoader dexClassLoader = new DexClassLoader(dexFile.getAbsolutePath(), optimizeDir.getAbsolutePath
